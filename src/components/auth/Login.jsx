...
import { Briefcase, Mail, Lock, Eye, EyeOff, Sparkles, History, PhoneCall, ArrowRight, LayoutDashboard } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";

/**
 * Login Component - Split Screen Marketing & Login Form
 * Displays credentials form on the left,
 * and Trackply features and support details on the right.
 * 
 * Routing:
 * - Links to "/signup"
 * - Navigates to "/dashboard" upon clicking "Log In"
 */
export default function Login() {
  ...
  const handleLogin = (e) => {
    ...
    // Phase 1: Direct navigation to the dashboard
    navigate("/dashboard");
  };
    ...
    <div className="min-h-screen md:h-screen bg-background text-foreground flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-1/2 bg-sidebar border-r border-border p-12 flex-col justify-between select-none md:h-full md:overflow-y-auto">
        ...
        <div className="my-auto py-10 space-y-8 max-w-lg">
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Trackply is a dedicated application tracker built for everyone managing multiple internships, online assessments, and interview rounds.
            </p>
          </div>
        ...
        <div className="text-[10px] text-muted-foreground/50 border-t border-border/40 pt-4">
          <span>&copy; {new Date().getFullYear()} Trackply. All rights reserved.</span>
        </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href="#"
                    onClick={(e) => { e.preventDefault(); alert("Forgot password is out of scope in Phase 1."); }}
